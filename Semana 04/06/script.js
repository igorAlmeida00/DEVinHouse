/*Ex06 Dado o array de cidades abaixo, filtre apenas
 as cidades com mais de 200000 habitantes;
...
let verificar = cidades.filter(function(acimaDuzentos) {
  return acimaDuzentos.populacao >= 200000;
});
